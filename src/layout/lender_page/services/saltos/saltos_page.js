...
class SaltosPage extends Component {
    ...
    createService = () => {
        ...
        serviciosDispController.writeServicioSalto(Salto,
            img,
        ...
        this.setState({
            percentageImageLoading: "none",
            mensaje: "Salto creado Exitosamente!!!",
            nombre: "",
            barrio: "",
            descripcion: "",
            localidad: "",
                    ...
                    <div className="row align-items-center">
                        <div className="col-12 col-md-6 textcenter">
                            ...
                            <h2 className="TextWhiteColor text-center">
                                Completa el siguiente formulario para que la genética de tu animal pueda llegar a un mercado mejor.
                            </h2>
                        </div>
