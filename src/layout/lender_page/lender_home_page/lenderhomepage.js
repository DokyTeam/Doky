        ...
        return (
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-12 col-md-6 col-lg-3">
                        <Cards servicename="Guardería" foto = {guarderia} lendercontenthandler={this.props.lendercontenthandler} descripcion = "¿Cansado que tu guardería siempre este vacía? Con el servicio de GUARDERIA de Doky puedes lograr que millones de usuarios encuentren tu guardería en todo momento."/>
                    </div> 
                    <div className="col-12 col-md-6 col-lg-3">
