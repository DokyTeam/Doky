...
import '../../layout/global_css/textcolors.css';
import '../../layout/global_css/colors.css';
import '../../layout/global_css/fonts.css';
            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 col-md-4 textcenter mb-2">
                        <h1 className="text-light  text-font font-italic text-uppercase HugeTextFont mt-1"> doky</h1>
